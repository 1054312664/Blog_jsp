					...
					<table width="573" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td valign="top" align="center">
								...
								<form name="form" method="post" action="ArticleServlet?method=2" onSubmit="return addArticle()">
									<table width="450" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#FECE62">
										<tr>
											...
											<td width="350" bgcolor="#FFFFFF">
												<div align="center">
													<input name="title" type="text" class="inputinput"
														size="30" style="width: 350px; height: 30px">
												</div>
											</td>
										</tr>
										<tr>
								...
								<select name="typeId" class="inputinput">
									...
									<%}%>
										...
										<tr>
											...
											<td bgcolor="#FFFFFF">
												<div align="center">
													<textarea name="content" cols="28" rows="20" class="inputinput" style="width: 350px; "></textarea>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td bgcolor="#FFFFFF">
												<div align="center">
											<input name="phTime" type="text" class="inputinput" value="<%=countTime.currentlyTime()%>" readonly="readonly">
												</div>
											</td>
										</tr>
									...
									&nbsp;&nbsp;
									<a href="#" onClick="javascript:form.reset()"><img src="images/reset.gif">
									</a>
								</form> 
								<%
